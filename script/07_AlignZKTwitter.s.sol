...
contract Deploy is BaseScript {
    function run() public broadcast returns (AlignAttestationStation alignStationImpl) {
        ...
        string memory claimType = "Align ZK Twitter";
        string memory claimLink =
            "https://github.com/AlignNetwork/Attestation-Registry/blob/master/registry/AlignZKTwitter.md";
        alignStationImpl.registerType(true, claimType, claimLink, true);
