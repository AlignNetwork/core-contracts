...
contract Deploy is BaseScript {
  function run() public broadcast returns (AlignAttestationStation alignStationImpl) {
    ...
    string memory claimType = "Align Token Price Prediction";
    string
      memory claimLink = "https://github.com/AlignNetwork/Attestation-Registry/blob/master/registry/AlignTokenPricePrediction.md";
    ...
    string
      memory claim = "I think the price of BTC_USD will be $46,000 on April 24,2024 (unix:1714058782), leeway +/- 1%.";
    string memory claimProof = "<ipfs link>";
